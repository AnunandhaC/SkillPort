import{j as e,D as I,e as z,F as D,f as S,g as E,U as B,h as R,B as U,E as M,P as _,i as L,T as Y,A as O}from"./ui-vendor-BQ24_H_W.js";import{r as y,L as P}from"./react-vendor-BUEQUwh2.js";import{u as T,a as W}from"./index-CwY1P4EE.js";import{_ as C}from"./pdf-vendor-B1zU7fDV.js";const q=({portfolio:s})=>{const{analyzePortfolio:g}=T(),x=y.useMemo(()=>g(s),[s,g]),[i,m]=y.useState([]),[c,o]=y.useState(""),[u,t]=y.useState(!1),p=y.useRef(null),l=y.useRef(null);y.useEffect(()=>{if(i.length===0&&s){const r=[{id:Date.now(),type:"bot",text:`Hello! I'm your Portfolio Assistant. I can help you improve your portfolio and answer questions about it. ${x.length>0?"I have some suggestions for you:":"Your portfolio looks great!"}`}];x.length>0?x.forEach((n,a)=>{r.push({id:Date.now()+a+1,type:"bot",text:`ðŸ’¡ ${n}`})}):r.push({id:Date.now()+1,type:"bot",text:"Your portfolio is well-structured! Feel free to ask me any questions about improving it further."}),m(r)}},[s,x]),y.useEffect(()=>{var d;(d=p.current)==null||d.scrollIntoView({behavior:"smooth"})},[i,u]);const w=d=>{const r=d.toLowerCase();if(r.includes("suggest")||r.includes("improve")||r.includes("help"))return x.length>0?`Based on your portfolio, here are my recommendations:
