import{j as e,D as $,e as N,F as S,f as v,g as T,U as C,h as D,B as I,E as M,P as A,i as P,T as E,k as R,A as Y}from"./ui-vendor-B4_zHjYU.js";import{r as g,L as w}from"./react-vendor-G9Mz0Wnd.js";import{u as k,a as L}from"./index-DHeNkz-w.js";import{_ as F}from"./pdf-vendor-BInbrGm8.js";const U=({portfolio:s})=>{const{analyzePortfolio:h}=k(),l=g.useMemo(()=>h(s),[s,h]),[n,c]=g.useState([]),[t,u]=g.useState(""),[i,a]=g.useState(!1),x=g.useRef(null),b=g.useRef(null);g.useEffect(()=>{if(n.length===0&&s){const d=[{id:Date.now(),type:"bot",text:`Hello! I'm your Portfolio Assistant. I can help you improve your portfolio and answer questions about it. ${l.length>0?"I have some suggestions for you:":"Your portfolio looks great!"}`}];l.length>0?l.forEach((f,o)=>{d.push({id:Date.now()+o+1,type:"bot",text:`💡 ${f}`})}):d.push({id:Date.now()+1,type:"bot",text:"Your portfolio is well-structured! Feel free to ask me any questions about improving it further."}),c(d)}},[s,l]),g.useEffect(()=>{var r;(r=x.current)==null||r.scrollIntoView({behavior:"smooth"})},[n,i]);const m=r=>{const d=r.toLowerCase();if(d.includes("suggest")||d.includes("improve")||d.includes("help"))return l.length>0?`Based on your portfolio, here are my recommendations:

${l.map((o,y)=>`${y+1}. ${o}`).join(`

`)}

Would you like me to elaborate on any of these?`:"Your portfolio looks great! To make it even better, consider adding more detailed project descriptions, showcasing your best work prominently, and keeping your skills section updated.";if(d.includes("skill")){const o=(s==null?void 0:s.skills)||[];return o.length===0?"I notice you haven't added any skills yet. Adding relevant skills helps employers quickly understand your expertise. Consider adding technical skills, programming languages, tools, and soft skills that match your projects and career goals.":`You have ${o.length} skill${o.length>1?"s":""} listed: ${o.join(", ")}. That's a good start! Consider adding more specific skills related to your projects, or skills that are in demand for your target roles.`}if(d.includes("project")){const o=(s==null?void 0:s.projects)||[];return o.length===0?"Projects are crucial for showcasing your practical experience! Add projects that demonstrate your skills, problem-solving abilities, and technical expertise. Include a clear title, description, technologies used, and if possible, links to live demos or GitHub repositories.":`You have ${o.length} project${o.length>1?"s":""} listed. Great! To make them stand out more, ensure each project has:
- A clear, descriptive title
- Detailed description of what it does
- Technologies/tools used
- Your role and contributions
- Links to demos or code (if available)`}if(d.includes("about")||d.includes("summary")||d.includes("bio")){const o=(s==null?void 0:s.about)||"";return!o||o.length<50?`Your "About" section is your first impression! Write a compelling professional summary (50+ words) that highlights:
- Who you are professionally
- Your key skills and interests
- What makes you unique
- Your career goals or what you're looking for

This helps visitors quickly understand your value proposition.`:`Your "About" section looks good! Make sure it's engaging and clearly communicates your professional identity. Consider updating it regularly to reflect your latest achievements and goals.`}if(d.includes("certif")||d.includes("certificate")){const o=(s==null?void 0:s.certifications)||[];return o.length===0?`Certifications add credibility to your portfolio! Consider adding:
- Professional certifications
- Online course completions
- Workshop or training certificates
- Academic achievements

These show your commitment to continuous learning and professional development.`:`You have ${o.length} certification${o.length>1?"s":""} listed. Excellent! Certifications validate your skills and show employers that you're committed to professional growth.`}if(d.includes("template")||d.includes("design")||d.includes("look")){const o=(s==null?void 0:s.templateId)||"modern";return`You're currently using the "${{modern:"Modern Minimal",creative:"Creative Bold",academic:"Academic Professional"}[o]||"Modern Minimal"}" template. Each template has its own style:
- Modern Minimal: Clean and professional
- Creative Bold: Eye-catching and dynamic
- Academic Professional: Structured and detailed

You can change templates anytime in the Portfolio Editor!`}if(d.includes("what")&&(d.includes("missing")||d.includes("need"))){const o=[];return(!(s!=null&&s.about)||s.about.length<50)&&o.push("a detailed About section"),(!(s!=null&&s.skills)||s.skills.length===0)&&o.push("Skills section"),(!(s!=null&&s.projects)||s.projects.length===0)&&o.push("Projects"),(!(s!=null&&s.certifications)||s.certifications.length===0)&&o.push("Certifications"),o.length>0?`Your portfolio could benefit from:

${o.map((y,z)=>`${z+1}. ${y}`).join(`
`)}
...
- Skills and projects
- Certifications
- Portfolio design and templates`];return f[Math.floor(Math.random()*f.length)]},p=async()=>{if(!t.trim()||i)return;const r={id:Date.now(),type:"user",text:t.trim()};c(d=>[...d,r]),u(""),a(!0),setTimeout(()=>{const d={id:Date.now()+1,type:"bot",text:m(r.text)};c(f=>[...f,d]),a(!1)},800)},j=r=>{r.key==="Enter"&&!r.shiftKey&&(r.preventDefault(),p())};return s?e.jsxs("div",{className:"flex flex-col h-[600px] bg-slate-900/50 rounded-xl border border-slate-700 overflow-hidden",children:[e.jsx("div",{className:"p-4 border-b border-slate-700 bg-gradient-to-r from-blue-600/20 to-purple-600/20",children:e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("div",{className:"p-2 bg-blue-600/20 rounded-lg",children:e.jsx(v,{className:"text-blue-400",size:20})}),e.jsxs("div",{children:[e.jsxs("h3",{className:"font-bold text-white flex items-center gap-2",children:["Portfolio Assistant",e.jsx(T,{className:"text-yellow-400",size:16})]}),e.jsx("p",{className:"text-xs text-slate-400",children:"Ask me anything about your portfolio"})]})]})}),e.jsxs("div",{className:"flex-1 overflow-y-auto p-4 space-y-4",children:[n.map(r=>e.jsxs("div",{className:`flex gap-3 ${r.type==="user"?"justify-end":"justify-start"}`,children:[r.type==="bot"&&e.jsx("div",{className:"flex-shrink-0 w-8 h-8 rounded-full bg-blue-600/20 flex items-center justify-center",children:e.jsx(v,{className:"text-blue-400",size:16})}),e.jsx("div",{className:`max-w-[80%] rounded-2xl px-4 py-2 ${r.type==="user"?"bg-blue-600 text-white":"bg-slate-800 text-slate-100 border border-slate-700"}`,children:e.jsx("p",{className:"text-sm whitespace-pre-line",children:r.text})}),r.type==="user"&&e.jsx("div",{className:"flex-shrink-0 w-8 h-8 rounded-full bg-purple-600/20 flex items-center justify-center",children:e.jsx(C,{className:"text-purple-400",size:16})})]},r.id)),i&&e.jsxs("div",{className:"flex gap-3 justify-start",children:[e.jsx("div",{className:"flex-shrink-0 w-8 h-8 rounded-full bg-blue-600/20 flex items-center justify-center",children:e.jsx(v,{className:"text-blue-400",size:16})}),e.jsx("div",{className:"bg-slate-800 text-slate-100 border border-slate-700 rounded-2xl px-4 py-2",children:e.jsxs("div",{className:"flex gap-1",children:[e.jsx("div",{className:"w-2 h-2 bg-slate-400 rounded-full animate-bounce",style:{animationDelay:"0ms"}}),e.jsx("div",{className:"w-2 h-2 bg-slate-400 rounded-full animate-bounce",style:{animationDelay:"150ms"}}),e.jsx("div",{className:"w-2 h-2 bg-slate-400 rounded-full animate-bounce",style:{animationDelay:"300ms"}})]})})]}),e.jsx("div",{ref:x})]}),e.jsxs("div",{className:"p-4 border-t border-slate-700 bg-slate-900/50",children:[e.jsxs("div",{className:"flex gap-2",children:[e.jsx("input",{ref:b,type:"text",value:t,onChange:r=>u(r.target.value),onKeyPress:j,placeholder:"Ask about your portfolio...",className:"flex-1 bg-slate-800 border border-slate-700 rounded-lg px-4 py-2 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500",disabled:i}),e.jsx("button",{onClick:p,disabled:!t.trim()||i,className:"px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2",children:e.jsx(D,{size:18})})]}),e.jsx("p",{className:"text-xs text-slate-500 mt-2",children:'Try: "How can I improve my portfolio?" or "What skills should I add?"'})]})]}):e.jsx("div",{className:"p-4 bg-slate-800/50 border border-slate-700 rounded-xl text-slate-400",children:e.jsx("p",{children:"Create a portfolio first to get personalized suggestions and chat with your Portfolio Assistant!"})})},_=({portfolio:s})=>{const{opportunities:h}=k(),l=g.useMemo(()=>{var c;if(!s)return[];const n=new Set(((c=s.skills)==null?void 0:c.map(t=>t.toLowerCase()))||[]);return h.filter(t=>t.requiredSkills.length===0?!0:t.requiredSkills.some(u=>n.has(u.toLowerCase())))},[s,h]);return s?e.jsxs("div",{className:"space-y-6",children:[e.jsxs("h3",{className:"text-xl font-bold text-white flex items-center gap-2",children:[e.jsx(I,{className:"text-blue-400"}),e.jsx("span",{children:"Recommended For You"})]}),l.length===0?e.jsx("p",{className:"text-slate-500",children:"No matching opportunities found based on your current skills."}):e.jsx("div",{className:"grid md:grid-cols-2 gap-4",children:l.map(n=>e.jsxs("div",{className:"glass-card p-6 rounded-xl border border-white/10 group",children:[e.jsxs("div",{className:"flex justify-between items-start mb-2",children:[e.jsx("span",{className:`text-xs px-2 py-1 rounded ${n.type==="Internship"?"bg-blue-500/20 text-blue-400":"bg-purple-500/20 text-purple-400"}`,children:n.type}),e.jsx("span",{className:"text-xs text-slate-500",children:"Match"})]}),e.jsx("h4",{className:"font-bold text-white text-lg group-hover:text-blue-400 transition",children:n.title}),e.jsx("p",{className:"text-slate-400 text-sm mb-4",children:n.company}),e.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:n.requiredSkills.map(c=>e.jsx("span",{className:"text-xs px-2 py-1 bg-white/5 rounded text-slate-300",children:c},c))}),e.jsx("button",{className:"w-full py-2 rounded-lg bg-white/5 hover:bg-white/10 text-white text-sm font-medium transition cursor-pointer",children:"View Details"})]},n.id))})]}):e.jsx("div",{className:"text-slate-500",children:"Create a portfolio to see matches."})},O=({portfolio:s})=>{const h=async()=>{if(!s)return;const{default:l}=await F(async()=>{const{default:i}=await import("./pdf-vendor-BInbrGm8.js").then(a=>a.j);return{default:i}},[],import.meta.url),n=new l;n.setFontSize(22),n.text("Portfolio Resume",20,20),n.setFontSize(12),n.text(`ID: ${s.studentId}`,20,30),n.setFontSize(16),n.text("Professional Summary",20,45),n.setFontSize(11);const c=n.splitTextToSize(s.about||"",170);n.text(c,20,55);let t=55+c.length*5+10;n.setFontSize(16),n.text("Skills",20,t),t+=10,n.setFontSize(11);const u=(s.skills||[]).join(", ");n.text(u,20,t),t+=20,n.setFontSize(16),n.text("Projects",20,t),t+=10,(s.projects||[]).forEach(i=>{n.setFontSize(12),n.setFont(void 0,"bold"),n.text(i.title,20,t),n.setFont(void 0,"normal"),t+=6,n.setFontSize(10),n.text(i.desc||"",20,t),t+=12}),n.save(`${s.studentId}_resume.pdf`)};return e.jsxs("button",{onClick:h,disabled:!s,className:"flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed",children:[e.jsx($,{size:18}),e.jsx("span",{children:"Download Resume PDF"})]})},W=({portfolio:s})=>{const h=()=>{if(!s)return"";const{about:c,skills:t,projects:u,certifications:i,templateId:a}=s,x=s.studentId||"portfolio";let b="";return a==="modern"?b=`
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
